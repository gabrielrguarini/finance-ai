...
interface LastTransationsProps {
  lastTransactions: Transaction[];
}

const LastTransations = ({ lastTransactions }: LastTransationsProps) => {
  const getAmountColor = (transation: Transaction) => {
    if (transation.type === TransactionType.EXPENSE) return "text-danger";
    if (transation.type === TransactionType.DEPOSIT) return "text-primary";
    if (transation.type === TransactionType.INVESTMENT) return "text-white";
  };
